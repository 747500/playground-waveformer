...
(function () {
	...
	function mk_top_pattern(ctx, hstart, hend, color) {
		...
		p.addColorStop(  0, c0); //'rgba(250, 150, 50, 1)'); // #fa9632
		p.addColorStop(0.4, c0); //'rgba(250, 150, 50, 1)');
		p.addColorStop(0.6, c1); //'rgba(250, 150, 50, 0.7)');
		p.addColorStop(  1, c1); //'rgba(250, 150, 50, 0.7)');
		return p;
	}
	...
	function mk_bottom_pattern(ctx, hstart, hend, color) {
		...
		var c0 = parseColor(color, 1);
		var c1 = parseColor(color, 0.7);
		p.addColorStop(  0, c0); //'rgba(50, 150, 250, 1)'); // #3296fa
		p.addColorStop(0.4, c0); //'rgba(50, 150, 250, 1)');
		p.addColorStop(0.6, c1); //'rgba(50, 150, 250, 0.7)');
		p.addColorStop(  1, c1); //'rgba(50, 150, 250, 0.7)');
		return p;
	}
...
//				var hend = (peaks[i] * ((style.size.height / 2) - hstart) + 1) + hstart;
